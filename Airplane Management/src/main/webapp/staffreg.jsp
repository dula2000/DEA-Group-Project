...
<title>Sign Up Form by Colorlib</title>  <!-- Change the title -->
	...
	<div class="main">
		...
		<section class="signup">
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Sign Up - Staff Member</h2>
						...
						<form method="post" action="RegistrationServlet" class="register-form"
							...
							<div class="form-group">
								<label for="nic"><i
									class="zmdi zmdi-account material-icons-nic"></i></label> <input
			...
			<div class="signup-image">
						<figure>
							<img src="images/stf.jpg" alt="sing up image">
						</figure>
